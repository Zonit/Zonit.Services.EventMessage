...
public class CommandHandlerGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateRegistrationExtensions(List<HandlerInfo> handlers, string assemblyName)
    {
        ...
        sb.AppendLine($"/// Auto-generated extension methods for registering command handlers from {assemblyName}.");
        sb.AppendLine("/// This class is generated by CommandHandlerGenerator.");
        sb.AppendLine("/// </summary>");
        sb.AppendLine($"public static class GeneratedCommandHandlerExtensions_{assemblyName}");
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>");
        ...
        sb.AppendLine($"        services.TryAddScoped<ICommandProvider, GeneratedCommandProvider_{assemblyName}>();");
        sb.AppendLine();
    ...
    private static string GenerateAotCommandProvider(List<HandlerInfo> handlers, string assemblyName)
    {
        var sb = new StringBuilder();
        ...
        sb.AppendLine();
        sb.AppendLine("/// <summary>");
        sb.AppendLine($"/// AOT-safe CommandProvider generated at compile time for {assemblyName}.");
        sb.AppendLine("/// Uses direct type resolution instead of MakeGenericType reflection.");
        sb.AppendLine("/// </summary>");
        sb.AppendLine($"internal sealed class GeneratedCommandProvider_{assemblyName} : ICommandProvider");
        sb.AppendLine("{");
        sb.AppendLine("    private readonly IServiceProvider _serviceProvider;");
        sb.AppendLine();
        sb.AppendLine($"    public GeneratedCommandProvider_{assemblyName}(IServiceProvider serviceProvider)");
        sb.AppendLine("    {");
