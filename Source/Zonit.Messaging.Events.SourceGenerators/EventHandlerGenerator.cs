...
public class EventHandlerGenerator : IIncrementalGenerator
{
    ...
    private static string GenerateRegistrationExtensions(List<EventHandlerInfo> handlers, string assemblyName)
    {
        ...
        sb.AppendLine($"/// Auto-generated extension methods for registering event handlers from {assemblyName}.");
        sb.AppendLine("/// This class is generated by EventHandlerGenerator.");
        sb.AppendLine("/// </summary>");
        sb.AppendLine($"public static class GeneratedEventHandlerExtensions_{assemblyName}");
        sb.AppendLine("{");
        sb.AppendLine("    /// <summary>");
